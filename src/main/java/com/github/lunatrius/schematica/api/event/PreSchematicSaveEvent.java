...
/**
 * This event is fired after the schematic has been Captured, but before it is serialized to the schematic format. This
 * is your opportunity to add Metadata. Register to this event using MinecraftForge.EVENT_BUS
 */
public class PreSchematicSaveEvent extends Event {
     ...
     * schematic will not be usable or will have blocks missing if you use an invalid value.
     *
